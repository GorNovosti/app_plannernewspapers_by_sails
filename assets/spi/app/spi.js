...
(function() {
  define('cs!newspapers/state',['cs!./../namespace'], function(namespace) {
    return {
      name: 'newspapers',
      url: 'release',
...
(function() {
  define('cs!states',['cs!./about/state', 'cs!./newspapers/state'], function(about_state, newspapers_state) {
    return {
      name: 'root',
      url: '/',
      template: '<section ui-view></section>',
      children: [about_state, newspapers_state]
    };
  });
